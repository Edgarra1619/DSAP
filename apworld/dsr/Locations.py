...
"Northern Undead Asylum": [
    DSRLocationData(11110002, f"UA: Undead Asylum - Courtyard Bonfire", f"Bonfire Warp Unlock - Undead Asylum - Courtyard", DSRLocationCategory.BONFIRE),
    DSRLocationData(11110003, f"UA: Undead Asylum - Boss Door opened", f"Door Filler", DSRLocationCategory.DOOR),
    DSRLocationData(11110005, f"UA: Undead Asylum - Interior Bonfire", f"Bonfire Warp Unlock - Undead Asylum - Interior", DSRLocationCategory.BONFIRE),
],
"Northern Undead Asylum - After Fog": [
...
"Northern Undead Asylum - After F2 East Door": [
    ...
    DSRLocationData(11110967, f"UA: Humanity - Asylum Demon Drop", f"Humanity", DSRLocationCategory.BOSS_HUMANITY),
...
"Firelink Shrine": [
    DSRLocationData(11110831, f"FS: Firelink Shrine Bonfire", f"Bonfire Warp Unlock - Firelink Shrine", DSRLocationCategory.BONFIRE),
...
"Firelink Shrine - Trusty Patches": [
    ...
    DSRLocationData(11110891, f"Trusty Patches: Eye of Death", f"Eye of Death x3", DSRLocationCategory.MISSABLE_SHOP_ITEM),
    DSRLocationData(11110892, f"Trusty Patches: Divine Blessing", f"Divine Blessing", DSRLocationCategory.MISSABLE_SHOP_ITEM),
    DSRLocationData(11110893, f"Trusty Patches: Humanity", f"Humanity x3", DSRLocationCategory.MISSABLE_SHOP_ITEM),
    DSRLocationData(11110894, f"Trusty Patches: Twin Humanities", f"Twin Humanities", DSRLocationCategory.MISSABLE_SHOP_ITEM),
    DSRLocationData(11110895, f"Trusty Patches: Miracle: Heal", f"Miracle: Heal", DSRLocationCategory.MISSABLE_SHOP_ITEM),
...
"Firelink Shrine - Rhea of Thorolund": [
    ...
    DSRLocationData(11110938, f"Rhea of Thorolund: Miracle: Great Heal Excerpt", f"Miracle: Great Heal Excerpt", DSRLocationCategory.MISSABLE_SHOP_ITEM),
    DSRLocationData(11110939, f"Rhea of Thorolund: Miracle: Homeward", f"Miracle: Homeward", DSRLocationCategory.MISSABLE_SHOP_ITEM),
    DSRLocationData(11110940, f"Rhea of Thorolund: Miracle: Force", f"Miracle: Force", DSRLocationCategory.MISSABLE_SHOP_ITEM),
    DSRLocationData(11110941, f"Rhea of Thorolund: Miracle: Wrath of the Gods", f"Miracle: Wrath of the Gods", DSRLocationCategory.MISSABLE_SHOP_ITEM),
    DSRLocationData(11110942, f"Rhea of Thorolund: Miracle: Seek Guidance", f"Miracle: Seek Guidance", DSRLocationCategory.MISSABLE_SHOP_ITEM),
    DSRLocationData(11110943, f"Rhea of Thorolund: Miracle: Magic Barrier", f"Miracle: Magic Barrier", DSRLocationCategory.MISSABLE_SHOP_ITEM),
],  
"Firelink Shrine - Domhnall of Zena": [
...
# ],
# # "Firelink Shrine - Domhnall of Zena - Post Gwyn": [
...
"Upper Undead Burg - Taurus Demon": [
    ...
    DSRLocationData(11110969, f"UB: Homeward Bone - Taurus Demon Drop", f"Homeward Bone", DSRLocationCategory.BOSS_BONE),
],
"Upper Undead Burg - Hellkite Bridge": [
    ...
    DSRLocationData(11110832, f"UB: Sunlight Altar Bonfire", f"Bonfire Warp Unlock - Sunlight Altar", DSRLocationCategory.BONFIRE),
...
"Northern Undead Asylum Second Visit": [
    ...
    DSRLocationData(11110993, f"UA2: Humanity - Stray Demon Drop", f"Humanity",  DSRLocationCategory.BOSS_HUMANITY),
    DSRLocationData(11110994, f"UA2: Homeward Bone - Stray Demon Drop", f"Homeward Bone",  DSRLocationCategory.BOSS_BONE),
    DSRLocationData(11110995, f"UA2: Titanite Slab - Stray Demon Drop", f"Titanite Slab",  DSRLocationCategory.BOSS_DROP),
],
"Northern Undead Asylum Second Visit - F2 West Door": [
...
"Upper Blighttown Depths Side": [
    ...
    DSRLocationData(11110138, f"BT: Blighttown Catwalk Bonfire", f"Bonfire Warp Unlock - Blighttown Catwalk", DSRLocationCategory.BONFIRE),
...
"Lower Blighttown": [
    ...
    DSRLocationData(11110152, f"BT: Blighttown Swamp Bonfire", f"Bonfire Warp Unlock - Blighttown Swamp", DSRLocationCategory.BONFIRE),
...
"Lower Blighttown - Shiva of the East": [
    ...
    DSRLocationData(11110898, f"Shiva of the East: East Wood Grain Ring", f"East Wood Grain Ring", DSRLocationCategory.MISSABLE_SHOP_ITEM),
],
"Lower Blighttown - Quelana of Izalith": [
    # DSRLocationData(11110xxx, f"BT: Quelana of Izalith", f"Quelana of Izalith Access", DSRLocationCategory.EVENT),
    DSRLocationData(11110922, f"Quelana of Izalith: Pyromancy: Fireball", f"Pyromancy: Fireball", DSRLocationCategory.MISSABLE_SHOP_ITEM),
    DSRLocationData(11110923, f"Quelana of Izalith: Pyromancy: Fire Orb", f"Pyromancy: Fire Orb", DSRLocationCategory.MISSABLE_SHOP_ITEM),
    DSRLocationData(11110924, f"Quelana of Izalith: Pyromancy: Great Fireball", f"Pyromancy: Great Fireball", DSRLocationCategory.MISSABLE_SHOP_ITEM),
    DSRLocationData(11110925, f"Quelana of Izalith: Pyromancy: Firestorm", f"Pyromancy: Firestorm", DSRLocationCategory.MISSABLE_SHOP_ITEM),
    DSRLocationData(11110926, f"Quelana of Izalith: Pyromancy: Fire Whip", f"Pyromancy: Fire Whip", DSRLocationCategory.MISSABLE_SHOP_ITEM),
    DSRLocationData(11110927, f"Quelana of Izalith: Pyromancy: Combustion", f"Pyromancy: Combustion", DSRLocationCategory.MISSABLE_SHOP_ITEM),
    DSRLocationData(11110928, f"Quelana of Izalith: Pyromancy: Great Combustion", f"Pyromancy: Great Combustion", DSRLocationCategory.MISSABLE_SHOP_ITEM),
    DSRLocationData(11110929, f"Quelana of Izalith: Pyromancy: Undead Rapport", f"Pyromancy: Undead Rapport", DSRLocationCategory.MISSABLE_SHOP_ITEM),
],
"Lower Blighttown - Quelaag": [
...
"Lower Blighttown - Eingyi": [
    ...
    DSRLocationData(11110919, f"Eingyi: Servant Roster", f"Servant Roster", DSRLocationCategory.MISSABLE_SHOP_ITEM),
    DSRLocationData(11110920, f"Eingyi: Pyromancy: Poison Mist", f"Pyromancy: Poison Mist", DSRLocationCategory.MISSABLE_SHOP_ITEM),
    DSRLocationData(11110921, f"Eingyi: Pyromancy: Toxic Mist", f"Pyromancy: Toxic Mist", DSRLocationCategory.MISSABLE_SHOP_ITEM),
],
"Upper Blighttown VotD Side": [
...
"Darkroot Basin": [
    DSRLocationData(11110184, f"DB: Twinkling Titanite - Crystal Lizard Drop, Descending Toward Hunter Set", f"Twinkling Titanite x2", DSRLocationCategory.CRYSTAL_LIZARD),
    DSRLocationData(11111014, f"DB: Extra Titanite - Crystal Lizard Drop, Descending Toward Hunter Set", f"Extra Titanite", DSRLocationCategory.CRYSTAL_LIZARD),
    ...
    DSRLocationData(11110648, f"DB: Antiquated Skirt", f"Antiquated Skirt", DSRLocationCategory.MISSABLE_DROP),
],
"Darkroot Basin - Princess Dusk": [
    # DSRLocationData(11110xxx, f"DG: Princess Dusk", f"Princess Dusk Access", DSRLocationCategory.EVENT),
    DSRLocationData(11110853, f"Princess Dusk: Sorcery: Hidden Weapon", f"Sorcery: Hidden Weapon", DSRLocationCategory.MISSABLE_SHOP_ITEM),
    DSRLocationData(11110854, f"Princess Dusk: Sorcery: Hidden Body", f"Sorcery: Hidden Body", DSRLocationCategory.MISSABLE_SHOP_ITEM),
    DSRLocationData(11110855, f"Princess Dusk: Sorcery: Cast Light", f"Sorcery: Cast Light", DSRLocationCategory.MISSABLE_SHOP_ITEM),
    DSRLocationData(11110856, f"Princess Dusk: Sorcery: Repair", f"Sorcery: Repair", DSRLocationCategory.MISSABLE_SHOP_ITEM),
    DSRLocationData(11110857, f"Princess Dusk: Sorcery: Chameleon", f"Sorcery: Chameleon", DSRLocationCategory.MISSABLE_SHOP_ITEM),
],
"Darkroot Garden - Before Fog": [
    ...
    DSRLocationData(11110194, f"DG: Darkroot Garden Bonfire", f"Bonfire Warp Unlock - Darkroot Garden", DSRLocationCategory.BONFIRE),
...
"The Great Hollow": [
    DSRLocationData(11110214, f"GH: The Great Hollow Bonfire", f"Bonfire Warp Unlock - The Great Hollow", DSRLocationCategory.BONFIRE),
    ...
    DSRLocationData(11111029, f"GH: Extra Titanite - Crystal Lizard Drop, Basilisk Overlook, Middle", f"Extra GH Titanite", DSRLocationCategory.CRYSTAL_LIZARD),
    DSRLocationData(11110221, f"GH: Twinkling Titanite - Crystal Lizard Drop, Basilisk Overlook, Left", f"Twinkling Titanite x2", DSRLocationCategory.CRYSTAL_LIZARD),
    DSRLocationData(11111030, f"GH: Extra Titanite - Crystal Lizard Drop, Basilisk Overlook, Left", f"Extra GH Titanite", DSRLocationCategory.CRYSTAL_LIZARD),
    DSRLocationData(11110222, f"GH: Twinkling Titanite - Crystal Lizard Drop, Above Red Titanite Chunk Location, Behind Branch", f"Twinkling Titanite x2", DSRLocationCategory.CRYSTAL_LIZARD),
    DSRLocationData(11111031, f"GH: Extra Titanite - Crystal Lizard Drop, Above Red Titanite Chunk Location, Behind Branch", f"Extra GH Titanite", DSRLocationCategory.CRYSTAL_LIZARD),
    DSRLocationData(11110223, f"GH: Twinkling Titanite - Crystal Lizard Drop, 2nd Platform By Top Ladder, Right", f"Twinkling Titanite x2", DSRLocationCategory.CRYSTAL_LIZARD),
    DSRLocationData(11111032, f"GH: Extra Titanite - Crystal Lizard Drop, 2nd Platform By Top Ladder, Right", f"Extra GH Titanite", DSRLocationCategory.CRYSTAL_LIZARD),
    DSRLocationData(11111033, f"GH: Twinkling Titanite - Crystal Lizard Drop, 2nd Platform By Top Ladder, Left", f"Twinkling Titanite x2", DSRLocationCategory.CRYSTAL_LIZARD),
    DSRLocationData(11111034, f"GH: Extra Titanite - Crystal Lizard Drop, 2nd Platform By Top Ladder, Left", f"Extra GH Titanite", DSRLocationCategory.CRYSTAL_LIZARD),
...
"Ash Lake": [
    ...
    DSRLocationData(11110836, f"ASH: Stone Dragon Bonfire", f"Bonfire Warp Unlock - Stone Dragon", DSRLocationCategory.BONFIRE),
],
"Sen's Fortress": [
...
"Sen's Fortress - After Second Fog": [
    ...
    DSRLocationData(11110252, f"SF: Sen's Fortress Bonfire", f"Bonfire Warp Unlock - Sen's Fortress", DSRLocationCategory.BONFIRE),
...
"Sen's Fortress - After Iron Golem": [
    DSRLocationData(11110259, f"SF: Core of an Iron Golem", f"Core of an Iron Golem", DSRLocationCategory.BOSS_SOUL),
    DSRLocationData(11110987, f"SF: Humanity - Iron Golem Drop", f"Humanity",  DSRLocationCategory.BOSS_HUMANITY),
],
"Sen's Fortress - After Cage Key": [
...
"Anor Londo - After Gwyndolin": [
    DSRLocationData(11110296, f"AL: Soul of Gwyndolin", f"Soul of Gwyndolin", DSRLocationCategory.BOSS_SOUL),
    ...
    DSRLocationData(11110839, f"AL: Chamber of the Princess Bonfire", f"Bonfire Warp Unlock - Chamber of the Princess", DSRLocationCategory.BONFIRE),
],
"Painted World of Ariamis": [
    DSRLocationData(11110840, f"PW: Painted World Bonfire", f"Bonfire Warp Unlock - Painted World", DSRLocationCategory.BONFIRE),
...
"Upper New Londo Ruins - Ingward": [
    ...
    DSRLocationData(11110913, f"Ingward: Sorcery: Resist Curse", f"Sorcery: Resist Curse", DSRLocationCategory.MISSABLE_SHOP_ITEM),
],
"New Londo Ruins Door to the Seal": [
...
"The Duke's Archives": [
    ...
    DSRLocationData(11110366, f"DA: Twinkling Titanite - Crystal Lizard Drop, Path To Seath's Study", f"Twinkling Titanite x2", DSRLocationCategory.CRYSTAL_LIZARD),
    DSRLocationData(11111017, f"DA: Extra Titanite - Crystal Lizard Drop, Path To Seath's Study", f"Extra Blue Titanite", DSRLocationCategory.CRYSTAL_LIZARD),
],
"The Duke's Archives - After First Seath Encounter": [
    ...
    DSRLocationData(11110367, f"DA: Duke's Archives Cell Bonfire", f"Bonfire Warp Unlock - Duke's Archives - Cell", DSRLocationCategory.BONFIRE),
...
"Crystal Cave": [
    ...
    DSRLocationData(11110395, f"CC: Twinkling Titanite - Crystal Lizard Drop, 1st Under Gold Golem", f"Twinkling Titanite x2", DSRLocationCategory.CRYSTAL_LIZARD),
    DSRLocationData(11111018, f"CC: Extra Titanite - Crystal Lizard Drop, 1st Under Gold Golem", f"Extra Blue Titanite", DSRLocationCategory.CRYSTAL_LIZARD),
    DSRLocationData(11110396, f"CC: Twinkling Titanite - Crystal Lizard Drop, 2nd Under Gold Golem", f"Twinkling Titanite x2", DSRLocationCategory.CRYSTAL_LIZARD),
    DSRLocationData(11111019, f"CC: Extra Titanite - Crystal Lizard Drop, 2nd Under Gold Golem", f"Extra Blue Titanite", DSRLocationCategory.CRYSTAL_LIZARD),
    DSRLocationData(11110397, f"CC: Twinkling Titanite - Crystal Lizard Drop, 3rd Under Gold Golem", f"Twinkling Titanite x2", DSRLocationCategory.CRYSTAL_LIZARD),
...
"Demon Ruins - Ceaseless Discharge": [
    ...
    DSRLocationData(11110981, f"DR: Humanity - Ceaseless Discharge Drop", f"Humanity",  DSRLocationCategory.BOSS_HUMANITY),
    DSRLocationData(11110982, f"DR: Homeward Bone - Ceaseless Discharge Drop", f"Homeward Bone",  DSRLocationCategory.BOSS_BONE),
],
"Demon Ruins": [
    ...
    DSRLocationData(11110412, f"DR: Demon Ruins - Burrowing Rockworm Bonfire", f"Bonfire Warp Unlock - Demon Ruins - Burrowing Rockworm", DSRLocationCategory.BONFIRE),
...
"Demon Ruins - Demon Firesage": [
    ...
    DSRLocationData(11110983, f"DR: Humanity - Demon Firesage Drop", f"Humanity",  DSRLocationCategory.BOSS_HUMANITY),
    DSRLocationData(11110984, f"DR: Demon's Catalyst - Demon Firesage Drop", f"Demon's Catalyst",  DSRLocationCategory.BOSS_DROP),
],
"Demon Ruins - After Demon Firesage": [
...
"Lost Izalith": [
    ...
    DSRLocationData(11110426, f"LI: Lost Izalith - Entrance Bonfire", f"Bonfire Warp Unlock - Lost Izalith - Entrance", DSRLocationCategory.BONFIRE),
    ...
    DSRLocationData(11110433, f"LI: Lost Izalith - Past Illusory Wall Bonfire", f"Bonfire Warp Unlock - Lost Izalith - Past Illusory Wall", DSRLocationCategory.BONFIRE),
...
"The Catacombs": [
    DSRLocationData(11110448, f"TC: Catacombs - Necromancer Cave Bonfire", f"Bonfire Warp Unlock - Catacombs - Necromancer Cave", DSRLocationCategory.BONFIRE),
],
"The Catacombs - Door 1": [
...
"The Catacombs - After Door 1": [  
    ...
    DSRLocationData(11110453, f"TC: Twinkling Titanite - Crystal Lizard Drop, Lower In Secret Statue Tunnel", f"Twinkling Titanite x2", DSRLocationCategory.CRYSTAL_LIZARD),
    DSRLocationData(11111021, f"TC: Extra Titanite - Crystal Lizard Drop, Lower In Secret Statue Tunnel", f"Extra White Titanite", DSRLocationCategory.CRYSTAL_LIZARD),
    DSRLocationData(11110454, f"TC: Twinkling Titanite - Crystal Lizard Drop, Higher In Secret Statue Tunnel", f"Twinkling Titanite x2", DSRLocationCategory.CRYSTAL_LIZARD),
    DSRLocationData(11111022, f"TC: Extra Titanite - Crystal Lizard Drop, Higher In Secret Statue Tunnel", f"Extra White Titanite", DSRLocationCategory.CRYSTAL_LIZARD),
    ...
    DSRLocationData(11110458, f"TC: Catacombs - Past Illusory Wall Bonfire", f"Bonfire Warp Unlock - Catacombs - Past Illusory Wall", DSRLocationCategory.BONFIRE),
    ...
    DSRLocationData(11110843, f"TC: Catacombs Vamos Bonfire", f"Bonfire Warp Unlock - Catacombs", DSRLocationCategory.BONFIRE),
...
"The Catacombs - After Pinwheel": [
    ...
    DSRLocationData(11110996, f"TC: Humanity - Pinwheel Drop", f"Humanity",  DSRLocationCategory.BOSS_HUMANITY),
    DSRLocationData(11110997, f"TC: Homeward Bone - Pinwheel Drop", f"Homeward Bone",  DSRLocationCategory.BOSS_BONE),
...
"Tomb of the Giants": [
    ...
    DSRLocationData(11110844, f"TotG: Tomb of the Giants Patches Bonfire", f"Bonfire Warp Unlock - Tomb of the Giants", DSRLocationCategory.BONFIRE),
...
"Tomb of the Giants - Behind Golden Fog Wall": [
    DSRLocationData(11110487, f"TotG: Twinkling Titanite - Crystal Lizard Drop, Start of Cave", f"Twinkling Titanite x2", DSRLocationCategory.CRYSTAL_LIZARD),
    DSRLocationData(11111023, f"TotG: Extra Titanite - Crystal Lizard Drop, Start of Cave", f"Extra White Titanite", DSRLocationCategory.CRYSTAL_LIZARD),
...
"Firelink Altar": [ 
    ...
    DSRLocationData(11110852, f"FA: Lordvessel Bonfire", f"Bonfire Warp Unlock - Firelink Altar - Lordvessel", DSRLocationCategory.BONFIRE),
],
"Kiln of the First Flame": [ 
...
"Sanctuary Garden - Sanctuary Guardian": [
    ...
    DSRLocationData(11110723, f"SG: Guardian Soul", f"Guardian Soul", DSRLocationCategory.BOSS_SOUL),
    DSRLocationData(11111000, f"SG: Humanity - Sanctuary Guardian Drop", f"Humanity",  DSRLocationCategory.BOSS_HUMANITY),
],                         
"Oolacile Sanctuary": [    
...
"Oolacile Sanctuary - Elizabeth": [
    ...
    DSRLocationData(11110964, f"Elizabeth: Gold Pine Resin", f"Gold Pine Resin x6", DSRLocationCategory.MISSABLE_SHOP_ITEM),
...
"Royal Wood": [
    ...
    DSRLocationData(11110744, f"RW: Twinkling Titanite - Crystal Lizard Drop, After Bridge With Kalameet Jumpscare", f"Twinkling Titanite x2", DSRLocationCategory.CRYSTAL_LIZARD),
    DSRLocationData(11111035, f"RW: Extra Titanite - Crystal Lizard Drop, After Bridge With Kalameet Jumpscare", f"Extra Titanite", DSRLocationCategory.CRYSTAL_LIZARD),
    DSRLocationData(11110745, f"RW: Twinkling Titanite - Crystal Lizard Drop, Near Elevator Top", f"Twinkling Titanite x2", DSRLocationCategory.CRYSTAL_LIZARD),
    DSRLocationData(11111036, f"RW: Extra Titanite - Crystal Lizard Drop, Near Elevator Top", f"Extra Blue Titanite", DSRLocationCategory.CRYSTAL_LIZARD),
...
"Oolacile Township": [    
    ...
    DSRLocationData(11110849, f"OT: Oolacile Township Bonfire", f"Bonfire Warp Unlock - Oolacile Township", DSRLocationCategory.BONFIRE),
    ...
    DSRLocationData(11111039, f"OT: Extra Titanite - Crystal Lizard Drop, Little Isolated Rooftop", f"Extra Blue Titanite", DSRLocationCategory.CRYSTAL_LIZARD),
    ...
    DSRLocationData(11110850, f"OT: Oolacile Township Dungeon Bonfire", f"Bonfire Warp Unlock - Oolacile Township Dungeon", DSRLocationCategory.BONFIRE),
],
...
"Chasm of the Abyss": [   
    ...
    DSRLocationData(11111040, f"CotA: Extra Titanite - Crystal Lizard Drop, Entrance", f"Extra White Titanite", DSRLocationCategory.CRYSTAL_LIZARD),
...
"Chasm of the Abyss - Manus": [   
    ...
    DSRLocationData(11110779, f"CotA: Soul of Manus", f"Soul of Manus", DSRLocationCategory.BOSS_SOUL),
    DSRLocationData(11111001, f"CotA: Humanity x10 - Manus Drop", f"Humanity x10",  DSRLocationCategory.BOSS_HUMANITY),
    DSRLocationData(11110851, f"CotA: Chasm of the Abyss Bonfire", f"Bonfire Warp Unlock - Chasm of the Abyss", DSRLocationCategory.BONFIRE),
]}
