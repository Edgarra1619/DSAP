...
_all_items_base = [    
    ...
    ("Bonfire Warp Unlock - Darkroot Garden", 1326, DSRItemCategory.BONFIREWARP),
    ("Bonfire Warp Unlock - Darkroot Basin", 1327, DSRItemCategory.BONFIREWARP),
    ("Bonfire Warp Unlock - Blighttown Catwalk", 1324, DSRItemCategory.BONFIREWARP),
    ("Bonfire Warp Unlock - Blighttown Swamp", 1325, DSRItemCategory.BONFIREWARP),
    ("Bonfire Warp Unlock - The Great Hollow", 1328, DSRItemCategory.BONFIREWARP),
    ("Bonfire Warp Unlock - Ash Lake - Entrance", 1329, DSRItemCategory.BONFIREWARP),
    ("Bonfire Warp Unlock - Demon Ruins - Entrance", 1334, DSRItemCategory.BONFIREWARP),
    ("Bonfire Warp Unlock - Demon Ruins - Burrowing Rockworm", 1335, DSRItemCategory.BONFIREWARP),
    ("Bonfire Warp Unlock - Demon Ruins - Catacombs", 1336, DSRItemCategory.BONFIREWARP),
    ("Bonfire Warp Unlock - Lost Izalith - Entrance", 1337, DSRItemCategory.BONFIREWARP),
    ("Bonfire Warp Unlock - Lost Izalith - Past Illusory Wall", 1338, DSRItemCategory.BONFIREWARP),
    ("Bonfire Warp Unlock - Lost Izalith - Heart of Chaos", 1339, DSRItemCategory.BONFIREWARP),
    ("Bonfire Warp Unlock - Sen's Fortress", 1330, DSRItemCategory.BONFIREWARP),
    ("Bonfire Warp Unlock - Anor Londo - Residence", 1331, DSRItemCategory.BONFIREWARP),
    ("Bonfire Warp Unlock - Duke's Archives - Entrance", 1332, DSRItemCategory.BONFIREWARP),
    ("Bonfire Warp Unlock - Duke's Archives - Cell", 1333, DSRItemCategory.BONFIREWARP),
    ("Bonfire Warp Unlock - Catacombs - Necromancer Cave", 1340, DSRItemCategory.BONFIREWARP),
    ("Bonfire Warp Unlock - Catacombs - Past Illusory Wall", 1341, DSRItemCategory.BONFIREWARP),
